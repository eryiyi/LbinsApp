...
public class ViewPagerAdapter extends PagerAdapter {
    ...
    public void change(List<Slide> paths) {
        mPaths = paths;
    }
    ...
    public Object instantiateItem(ViewGroup container, final int position) {
        ...
        imageLoader.displayImage(mPaths.get(position).getPicAddress(), holder.iv, UniversityApplication.options,animateFirstListener);
