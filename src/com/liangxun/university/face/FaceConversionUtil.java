package com.liangxun.university.face;
...
public class FaceConversionUtil {
    ...
    public SpannableString getExpressionString(Context context, String str,int textsize) {
        ...
        try {
            dealExpression(context, spannableString, sinaPatten, 0,textsize);
        } catch (Exception e) {
...
//        bitmap = Bitmap.createScaledBitmap(bitmap);
    ...
    private void dealExpression(Context context,
                                SpannableString spannableString, Pattern patten, int start,int textsize)
            throws Exception {
