 ...
 * {@link VideoImageCache#getInstance(FragmentManager, ImageCacheParams)}
...
public class VideoImageCache {
     ...
     */
    private VideoImageCache(ImageCacheParams cacheParams) {
        init(cacheParams);
    }

    /**
     * Return an {@link VideoImageCache} instance. A {@link RetainFragment} is used
     ...
     * not exist
     */
    public static VideoImageCache getInstance(FragmentManager fragmentManager,
        ...
        VideoImageCache imageCache = (VideoImageCache) mRetainFragment.getObject();

        // No existing ImageCache, create one and store it in RetainFragment
        if (imageCache == null) {
            imageCache = new VideoImageCache(cacheParams);
