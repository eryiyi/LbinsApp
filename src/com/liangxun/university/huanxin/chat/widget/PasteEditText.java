 ...
 */
package com.liangxun.university.huanxin.chat.widget;
...
import com.liangxun.university.huanxin.chat.activity.HxAlertDialog;
...
//                intent.setDataAndType(Uri.fromFile(new File("/sdcard/mn1.jpg")), "image/*");     
                ...
                Intent intent = new Intent(context, HxAlertDialog.class);
