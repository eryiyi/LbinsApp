    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            if (progressDialog == null) {
                progressDialog = new CustomProgressDialog(this , st1, R.anim.frame_paopao);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.clear_all_history: // 清空聊天记录
                ...
                Intent intent = new Intent(GroupDetailsActivity.this, HxAlertDialog.class);
                    ...
                    public void onClick(View v) {
                        if (isInDeleteMode) {
                            ...
                            if (EMChatManager.getInstance().getCurrentUser().equals(username)) {
                                startActivity(new Intent(GroupDetailsActivity.this, HxAlertDialog.class).putExtra("msg", st12));
                                return;
                            }
