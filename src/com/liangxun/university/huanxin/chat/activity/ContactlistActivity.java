...
import com.liangxun.university.huanxin.chat.adapter.ContactAdapter;
...
import com.liangxun.university.huanxin.chat.widget.Sidebar;
import com.liangxun.university.ui.PaoPaokefuActivity;
        ...
        new Thread(new Runnable() {
            public void run() {
                try {
                    ...
                    getMyApp().getContactList().remove(tobeDeleteUser.getUsername());
