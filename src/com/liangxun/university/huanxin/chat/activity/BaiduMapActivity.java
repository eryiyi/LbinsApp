...
public class BaiduMapActivity extends HxBaseActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        MapStatusUpdate msu = MapStatusUpdateFactory.zoomTo(suo);
    ...
    private void showMap(double latitude, double longtitude, String address) {
        ...
        MapStatusUpdate u = MapStatusUpdateFactory.newLatLngZoom(convertLatLng, suo);
        mBaiduMap.animateMapStatus(u);
    }

    private void showMapWithLocationClient() {
        String str1 = getResources().getString(R.string.Making_sure_your_location);
        progressDialog = new CustomProgressDialog(BaiduMapActivity.this , str1, R.anim.frame_paopao);
