...
import com.liangxun.university.huanxin.chat.utils.CameraHelper;
            ...
            if (!cameraHelper.isStarted()) {
                if (!isInComingCall) {
                    try {
                        ...
                        Toast.makeText(VideoCallActivity.this, st1, Toast.LENGTH_LONG).show();
                    }
                }
                    ...
                    public void onResponse(String s) {
                        if (StringUtil.isJson(s)) {
                            ...
                            if (data.getCode() == 200) {
                                ...
                                Toast.makeText(VideoCallActivity.this, "获得数据失败，请稍后重试", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(VideoCallActivity.this, "获得数据失败，请稍后重试", Toast.LENGTH_SHORT).show();
                        }
