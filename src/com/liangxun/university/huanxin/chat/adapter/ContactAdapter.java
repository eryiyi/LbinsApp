        ...
        if(user!=null){
            ...
            if (username.equals(HxConstant.NEW_FRIENDS_USERNAME)) {
                ...
                if (unreadMsgView != null)
                    unreadMsgView.setVisibility(View.INVISIBLE);
                imageLoader.displayImage(userDao.getCoverByName(username), avatar, UniversityApplication.txOptions, animateFirstListener);
