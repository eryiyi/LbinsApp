...
public class Paopao_goods {
    ...
    public String getGoods_school_id() {
        return goods_school_id;
    }

    public void setGoods_school_id(String goods_school_id) {
        this.goods_school_id = goods_school_id;
    }
