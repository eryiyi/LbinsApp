...
import com.liangxun.university.util.HttpUtils;
...
public class LoginActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!StringUtil.isNullOrEmpty(username) && !StringUtil.isNullOrEmpty(pwr)) {
            progressDialog = new CustomProgressDialog(LoginActivity.this , "正在加载", R.anim.frame_paopao);
...
//                registerPage.show(this);
            ...
            case R.id.login_register:
                Intent regist = new Intent(this, RegistSelectSchoolActivity.class);
