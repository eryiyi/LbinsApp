...
import com.liangxun.university.widget.popview.IsSurePrizesWindow;
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.pk_favour_liner:
                progressDialog = new CustomProgressDialog(Pk_new_detailsActivity.this , "正在加载", R.anim.frame_paopao);
