 ...
 * 类的功能、说明写在此处.
 */
public class GoodsTelPopWindow extends PopupWindow {


    private TextView camera, cancel, mapstorage,qq;
    private View mMenuView;

    public GoodsTelPopWindow(Activity context, View.OnClickListener itemsOnClick) {
        super(context);
        LayoutInflater inflater = (LayoutInflater) context
                .getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        mMenuView = inflater.inflate(R.layout.item_dialog_tel_goods, null);
